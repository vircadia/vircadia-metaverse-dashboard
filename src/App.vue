...
<template>
    <v-app>
        ...
        <v-footer
            ...
            app
        >
            <span class="white--text">Iamus Dashboard v1.1.0 | Vircadia | <a class="white--text" href="https://github.com/vircadia/project-iamus-dashboard/issues">Feedback</a></span>
            <v-spacer></v-spacer>
